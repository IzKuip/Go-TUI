...
func main() {
	...
	drawText(20, 18, "There are some premade chalk.Style variables to get you started.", blackYellowBg) // Draw example text four
	drawText(4, 3, "drawDialog(title string, message string, x int, y int)", blackYellowBg)             // Draw example text five
